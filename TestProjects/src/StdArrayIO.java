...
public class StdArrayIO {
    ...
    /**
     * Read in and return an array of long from standard input.
     */
    public static long[] readLong1D() {
        int N = StdIn.readInt();
        long[] a = new long[N];
        for (int i = 0; i < N; i++) {
            a[i] = (long) StdIn.readDouble();
        }
        return (long[])a;
    }
    ...
    /**
     * Read in and return an M-by-N array of long from standard input.
     */ 
    public static long[][] readLong2D() {
        int M = StdIn.readInt();
        int N = StdIn.readInt();
        long[][] a = new long[M][N];
        for (int i = 0; i < M; i++) {
            for (int j = 0; j < N; j++) {
                a[i][j] = StdIn.readLong();
            }
        }
        return a;
    }
